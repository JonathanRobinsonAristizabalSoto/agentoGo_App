...
## 7) Despliegue y Backups

- Guía de despliegue: [docs/DEPLOY.md](docs/DEPLOY.md)
- Guía de backups y restauración: [docs/BACKUPS.md](docs/BACKUPS.md)

Recomendación inmediata: seguir `docs/DEPLOY.md` para preparar `staging` y realizar un primer despliegue de prueba. Mantener snapshots de DB antes de migraciones grandes.
